...
export const estrellada: Design = {
   ...
   */
  adornos: [
    { seccion: "splash", url: `${A}/luna.png`, sitio: "cabecera", tamano: 42 },
    { seccion: "countdown", url: `${A}/luna.png`, sitio: "cabecera", tamano: 31 },
    { seccion: "gifts", url: `${A}/sello.png`, sitio: "cabecera", tamano: 31 },
    { seccion: "guests", url: `${A}/constelacion.png`, sitio: "cabecera", tamano: 64 },
    { seccion: "footer", url: `${A}/luna.png`, sitio: "cabecera", tamano: 33 },
