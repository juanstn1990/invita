...
.fotos-btn{display:block;width:max-content;max-width:100%;margin:24px auto 0;
  padding:15px 30px;border-radius:var(--btn-radius);background:var(--accent);
  color:var(--on-accent);text-decoration:none;font-size:var(--fs-micro);
  letter-spacing:var(--tracking);text-transform:var(--caps)}

/* ── Libro de deseos ── */
.deseos-btn{display:block;width:max-content;max-width:100%;margin:24px auto 0;
  padding:15px 30px;border-radius:var(--btn-radius);background:var(--accent);
  color:var(--on-accent);text-decoration:none;font-size:var(--fs-micro);
  letter-spacing:var(--tracking);text-transform:var(--caps)}
...
.hero-btn,.gifts-btn,.confirm-btn,.splash-btn,.event-map-btn,.social-ig,.fotos-btn,.deseos-btn{
  transition:transform .25s ease,opacity .25s ease,background .25s ease,
    color .25s ease,box-shadow .25s ease}
.hero-btn:hover,.gifts-btn:hover,.confirm-btn:hover,.fotos-btn:hover,.deseos-btn:hover{transform:translateY(-2px)}
...
@media (prefers-reduced-motion:reduce){
  ...
  .hero-btn:hover,.gifts-btn:hover,.confirm-btn:hover,.fotos-btn:hover,.deseos-btn:hover{transform:none}
}
