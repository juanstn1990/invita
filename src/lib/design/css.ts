...
.hero-btn,.gifts-btn,.confirm-btn,.splash-btn,.event-map-btn,.social-ig,.fotos-btn{
  transition:transform .25s ease,opacity .25s ease,background .25s ease,
    color .25s ease,box-shadow .25s ease}
.hero-btn:hover,.gifts-btn:hover,.confirm-btn:hover,.fotos-btn:hover{transform:translateY(-2px)}
...
@media (prefers-reduced-motion:reduce){
  ...
  .hero-btn:hover,.gifts-btn:hover,.confirm-btn:hover,.fotos-btn:hover{transform:none}
}
