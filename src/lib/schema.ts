...
export const SITIOS: { value: string; label: string }[] = [
  ...
  /* En el flujo y no encima: es el sitio de la filigrana que casi todos los
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "velas", label: "Unas velas encendidas: se tocan y la luz lo llena todo" },
        ],
        help: "Lo que pasa al pulsar el botón. Con «sobre con sello» el velo es un sobre cerrado y el sello es lo que se toca.",
      },
      {
        key: "sello",
        label: "Imagen del sello o de la tapa",
        type: "image",
        span: 2,
        showIf: { key: "apertura", value: ["sello", "libro", "abanico"] },
        help: "Con «sobre con sello», un PNG redondo como un lacre; con «libro», la tapa; con «abanico», el abanico abierto. Vacío = lo que traiga el diseño.",
      },
      textColor,
    ],
  },
...

  {
    ...
    fields: [
      ...
      ...sectionHeaderFields("Con todo nuestro amor", "Queridos invitados"),
      {
        ...
        type: "textarea",
        span: 2,
        help: "Para poner una palabra en negrilla, escríbela entre <strong> y </strong>. Ej: <strong>gracias</strong>.",
      },
